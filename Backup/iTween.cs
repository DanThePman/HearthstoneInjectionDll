...
public class iTween
{
    ...
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map45;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map46;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map47;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map48;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map49;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map4A;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map4B;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map4C;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map4D;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map4E;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map4F;
    [CompilerGenerated]
    private static Dictionary<string, int> <>f__switch$map50;
    public bool activeLastTick;
    private ApplyTween apply;
    private AudioSource audioSource;
    private static string[] CALLBACK_NAMES = new string[] { "onstart", "onupdate", "oncomplete", "onconflict" };
    private static string[] CALLBACK_PARAMS_NAMES = new string[] { "onstartparams", "onupdateparams", "oncompleteparams", "onconflictparams" };
    private static string[] CALLBACK_TARGET_NAMES = new string[] { "onstarttarget", "onupdatetarget", "oncompletetarget", "onconflicttarget" };
    ...
    private void ApplyColorToTargets()
    {
        ...
        if (this.GetComponent(typeof(GUITexture)) != null)
        {
            this.guiTexture.color = this.colors[0, 2];
        }
        else if (this.GetComponent(typeof(GUIText)) != null)
        {
    ...
    {
        string key = CALLBACK_NAMES[(int) callbackType];
        string str2 = CALLBACK_PARAMS_NAMES[(int) callbackType];
        string str3 = CALLBACK_TARGET_NAMES[(int) callbackType];
        if (this.tweenArguments.Contains(key) && !this.tweenArguments.Contains("ischild"))
        {
            GameObject gameObject;
            if (this.tweenArguments.Contains(str3))
            {
                gameObject = (GameObject) this.tweenArguments[str3];
            }
            else
            {
            ...
            if (gameObject == null)
            {
                Debug.LogError(string.Format("iTween Error: target is null! callbackType={0} tween={1}", key, this));
            }
            else
            {
                object obj3 = this.tweenArguments[key];
                if (obj3 is Action<object>)
                {
                    ((Action<object>) obj3)(this.tweenArguments[str2]);
                }
                else if (obj3 is string)
                {
                    gameObject.SendMessage((string) obj3, this.tweenArguments[str2], SendMessageOptions.DontRequireReceiver);
                }
                else
                {
    ...
    private void ConflictCheck()
    {
        ...
        {
            if ((!tween.destroyed && (tween.gameObject == this.gameObject)) && (tween != this))
            {
                if (tween.type == "value")
                {
                    return;
                ...
                if (tween.isRunning && (tween.type == this.type))
                {
                    ...
                    {
                        tween.Dispose();
                        tween.CallBack(CallbackType.OnConflict);
                        return;
                    }
                    ...
                    this.Dispose();
                    this.CallBack(CallbackType.OnConflict);
                }
            }
        }
    }
    ...
    public static int Count(string type)
    {
        ...
        while ((tween = iterator.GetNext()) != null)
        {
            if ((tween.type + tween.method).Substring(0, type.Length).ToLower().Equals(type.ToLower()))
            {
                num++;
            }
        }
    ...
    {
        int num = 0;
        foreach (iTween tween in iTweenManager.GetTweensForObject(target))
        {
    ...
    private float easeOutElasticLight(float start, float end, float value)
    {
        ...
        float num2 = num / 4f;
        float num3 = end;
        return ((((num3 * Mathf.Pow(2f, -10f * value)) * Mathf.Sin(((value - num2) * 6.283185f) / num)) + end) + start);
    }
    ...
    private void GenerateColorToTargets()
    {
        ...
        else
        {
            ...
            if (this.tweenArguments.Contains("a"))
            {
                ...
                {
                    this.colors[num7, 1].a = (float) this.tweenArguments["a"];
                }
            }
        }
        if (this.tweenArguments.Contains("amount"))
        {
            ...
            {
                this.colors[num8, 1].a = (float) this.tweenArguments["amount"];
            }
        }
        else if (this.tweenArguments.Contains("alpha"))
        {
            for (int num9 = 0; num9 < this.colors.GetLength(0); num9++)
            {
                this.colors[num9, 1].a = (float) this.tweenArguments["alpha"];
            }
        }
    }
    ...
    private static int GenerateID()
    {
        ...
        iTween.nextId = (iTween.nextId != 0x7fffffff) ? (iTween.nextId + 1) : 1;
        return nextId;
    }
    ...
    private void GenerateLookToTargets()
    {
        ...
        if (this.tweenArguments.Contains("looktarget"))
        {
            if (this.tweenArguments["looktarget"].GetType() == typeof(Transform))
            {
                ...
                this.transform.LookAt((Transform) this.tweenArguments["looktarget"], !nullable.HasValue ? Defaults.up : nullable.Value);
            }
            else if (this.tweenArguments["looktarget"].GetType() == typeof(Vector3))
            {
                Vector3? nullable2 = (Vector3?) this.tweenArguments["up"];
                this.transform.LookAt((Vector3) this.tweenArguments["looktarget"], !nullable2.HasValue ? Defaults.up : nullable2.Value);
            }
        }
        else
        {
        ...
        if (this.tweenArguments.Contains("axis"))
        {
            ...
            {
                int num2;
                if (<>f__switch$map4F == null)
                {
                    Dictionary<string, int> dictionary = new Dictionary<string, int>(3);
                    dictionary.Add("x", 0);
                    dictionary.Add("y", 1);
                    dictionary.Add("z", 2);
                    <>f__switch$map4F = dictionary;
                }
                if (<>f__switch$map4F.TryGetValue(key, out num2))
                {
                    switch (num2)
                    {
                        case 0:
    ...
    private void GenerateMoveByTargets()
    {
        ...
        this.vector3s[3] = vector = this.transform.position;
    ...
    private void GenerateMoveToPathTargets()
    {
        ...
        if (this.transform.position != vectorArray[0])
        {
    ...
    private void GenerateRotateAddTargets()
    {
        Vector3 vector;
        this.vector3s = new Vector3[5];
        this.vector3s[3] = vector = this.transform.eulerAngles;
        this.vector3s[0] = this.vector3s[1] = vector;
        if (this.tweenArguments.Contains("amount"))
        {
            this.vector3s[1] += (Vector3) this.tweenArguments["amount"];
    ...
    private void GenerateTargets()
    {
        ...
        if (type != null)
        {
            ...
            if (<>f__switch$map4E == null)
            {
                ...
                <>f__switch$map4E = dictionary;
            }
            if (<>f__switch$map4E.TryGetValue(type, out num))
            {
                string method;
                int num2;
                switch (num)
                {
                    case 0:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map45 == null)
                            {
                                ...
                                <>f__switch$map45 = dictionary;
                            }
                            if (<>f__switch$map45.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 1:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map46 == null)
                            {
                                dictionary = new Dictionary<string, int>(1);
                                dictionary.Add("to", 0);
                                <>f__switch$map46 = dictionary;
                            }
                            if (<>f__switch$map46.TryGetValue(method, out num2) && (num2 == 0))
                            {
                    ...
                    case 2:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map47 == null)
                            {
                                dictionary = new Dictionary<string, int>(1);
                                dictionary.Add("to", 0);
                                <>f__switch$map47 = dictionary;
                            }
                            if (<>f__switch$map47.TryGetValue(method, out num2) && (num2 == 0))
                            {
                    ...
                    case 3:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map48 == null)
                            {
                                dictionary = new Dictionary<string, int>(3);
                                dictionary.Add("to", 0);
                                dictionary.Add("by", 1);
                                dictionary.Add("add", 1);
                                <>f__switch$map48 = dictionary;
                            }
                            if (<>f__switch$map48.TryGetValue(method, out num2))
                            {
                                if (num2 == 0)
                                {
                    ...
                    case 4:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map49 == null)
                            {
                                dictionary = new Dictionary<string, int>(3);
                                dictionary.Add("to", 0);
                                dictionary.Add("by", 1);
                                dictionary.Add("add", 2);
                                <>f__switch$map49 = dictionary;
                            }
                            if (<>f__switch$map49.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 5:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map4A == null)
                            {
                                dictionary = new Dictionary<string, int>(3);
                                dictionary.Add("to", 0);
                                dictionary.Add("add", 1);
                                dictionary.Add("by", 2);
                                <>f__switch$map4A = dictionary;
                            }
                            if (<>f__switch$map4A.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 6:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map4B == null)
                            {
                                dictionary = new Dictionary<string, int>(3);
                                dictionary.Add("position", 0);
                                dictionary.Add("scale", 1);
                                dictionary.Add("rotation", 2);
                                <>f__switch$map4B = dictionary;
                            }
                            if (<>f__switch$map4B.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 7:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map4C == null)
                            {
                                dictionary = new Dictionary<string, int>(3);
                                dictionary.Add("position", 0);
                                dictionary.Add("rotation", 1);
                                dictionary.Add("scale", 2);
                                <>f__switch$map4C = dictionary;
                            }
                            if (<>f__switch$map4C.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 8:
                        ...
                        if (method != null)
                        {
                            if (<>f__switch$map4D == null)
                            {
                                dictionary = new Dictionary<string, int>(1);
                                dictionary.Add("to", 0);
                                <>f__switch$map4D = dictionary;
                            }
                            if (<>f__switch$map4D.TryGetValue(method, out num2) && (num2 == 0))
                            {
    ...
    private void GetEasingFunction()
    {
        switch (this.easeType)
        {
            ...
            case EaseType.easeOutElasticLight:
                this.ease = new EasingFunction(this.easeOutElasticLight);
                break;
        }
    }
    ...
    {
        if (((this.activeInHierarchy && !this.waitForDelay) && (this.tweenArguments != null)) && ((this.tweenArguments.Contains("looktarget") && this.isRunning) && (((this.type == "move") || (this.type == "shake")) || (this.type == "punch"))))
        {
            LookUpdate(this.gameObject, this.tweenArguments);
        }
    }
    ...
    public static void LookUpdate(GameObject target, Hashtable args)
    {
        ...
        if (args.Contains("axis"))
        {
            ...
            {
                int num2;
                if (<>f__switch$map50 == null)
                {
                    Dictionary<string, int> dictionary = new Dictionary<string, int>(3);
                    dictionary.Add("x", 0);
                    dictionary.Add("y", 1);
                    dictionary.Add("z", 2);
                    <>f__switch$map50 = dictionary;
                }
                if (<>f__switch$map50.TryGetValue(key, out num2))
                {
                    switch (num2)
                    {
                        case 0:
    ...
    {
        this.delayStarted = UnityEngine.Time.time;
    ...
    private void RetrieveArgs()
    {
        if (this.tweenArguments != null)
        {
            ...
            if (this.tweenArguments.Contains("namedcolorvalue"))
            {
                ...
                {
                    this.namedColorValueString = ((NamedValueColor) ((int) this.tweenArguments["namedcolorvalue"])).ToString();
                }
                ...
                else
                {
                    try
                    {
                        this.namedColorValueString = ((NamedValueColor) ((int) Enum.Parse(typeof(NamedValueColor), (string) this.tweenArguments["namedcolorvalue"], true))).ToString();
                    }
                    catch
                    {
    ...
    public override string ToString()
    {
        ...
        object obj2 = this.tweenArguments["type"];
        object obj3 = this.tweenArguments["method"];
        object obj4 = this.tweenArguments["name"];
        object obj5 = this.tweenArguments["id"];
        object[] args = new object[] { name, obj2, obj3, obj4, obj5 };
    ...
    public void Update()
    {
        if (this.activeInHierarchy)
        {
            ...
            {
                if ((this.delay > 0f) && (this.delay > (UnityEngine.Time.time - this.delayStarted)))
                {
                    return;
                }
                this.TweenStart();
