...
public class VictoryTwoScoop : EndGameTwoScoop
{
    ...
    {
        return new <AnimateAll>c__Iterator80 { <>f__this = this };
    }
    ...
    {
        object[] args = new object[] { "z", -0.78f, "time", 5, "isLocal", true, "easetype", iTween.EaseType.easeInOutBack, "oncomplete", "AnimateCrownFro", "oncompletetarget", base.gameObject };
        Hashtable hashtable = iTween.Hash(args);
        iTween.MoveTo(this.m_crown, hashtable);
    }
    ...
    {
        return new <ResetPositionsForGoldEvent>c__Iterator81 { <>f__this = this };
    }

    protected override void ShowImpl()
    {
        base.m_heroActor.SetEntityDef(GameState.Get().GetFriendlySidePlayer().GetHero().GetEntityDef());
        base.m_heroActor.SetCardDef(GameState.Get().GetFriendlySidePlayer().GetHero().GetCard().GetCardDef());
    ...
    [CompilerGenerated]
    private sealed class <AnimateAll>c__Iterator80 : IDisposable, IEnumerator, IEnumerator<object>
    {
    ...
    [CompilerGenerated]
    private sealed class <ResetPositionsForGoldEvent>c__Iterator81 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal VictoryTwoScoop <>f__this;
        internal Hashtable <cloudMoveArgsLeft>__2;
        internal Hashtable <cloudMoveArgsRight>__1;
        internal Hashtable <crownMoveArgs>__5;
        internal Hashtable <godray2RotationArgs>__7;
        internal Hashtable <godrayRotationArgs>__6;
        internal Hashtable <laurelMoveArgsLeft>__4;
        internal Hashtable <laurelMoveArgsRight>__3;
        internal float <resetTime>__0;
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 2:
                {
                    this.<resetTime>__0 = 0.25f;
                    object[] args = new object[] { "position", new Vector3(-1.211758f, -0.8f, -0.2575677f), "time", this.<resetTime>__0, "isLocal", true, "easetype", iTween.EaseType.linear };
                    this.<cloudMoveArgsRight>__1 = iTween.Hash(args);
                    iTween.MoveTo(this.<>f__this.m_rightCloud, this.<cloudMoveArgsRight>__1);
                    object[] objArray2 = new object[] { "position", new Vector3(1.068925f, -0.8f, -0.197469f), "time", this.<resetTime>__0, "isLocal", true, "easetype", iTween.EaseType.linear };
                    this.<cloudMoveArgsLeft>__2 = iTween.Hash(objArray2);
                    iTween.MoveTo(this.<>f__this.m_leftCloud, this.<cloudMoveArgsLeft>__2);
                    this.<>f__this.m_rightLaurel.transform.localRotation = Quaternion.Euler(Vector3.zero);
                    object[] objArray3 = new object[] { "position", new Vector3(0.1723f, -0.206f, 0.753f), "time", this.<resetTime>__0, "isLocal", true, "easetype", iTween.EaseType.linear };
                    this.<laurelMoveArgsRight>__3 = iTween.Hash(objArray3);
                    iTween.MoveTo(this.<>f__this.m_rightLaurel, this.<laurelMoveArgsRight>__3);
                    this.<>f__this.m_leftLaurel.transform.localRotation = Quaternion.Euler(Vector3.zero);
                    object[] objArray4 = new object[] { "position", new Vector3(-0.2201783f, -0.318f, 0.753f), "time", this.<resetTime>__0, "isLocal", true, "easetype", iTween.EaseType.linear };
                    this.<laurelMoveArgsLeft>__4 = iTween.Hash(objArray4);
                    iTween.MoveTo(this.<>f__this.m_leftLaurel, this.<laurelMoveArgsLeft>__4);
                    object[] objArray5 = new object[] { "z", -0.9677765f, "time", this.<resetTime>__0, "isLocal", true, "easetype", iTween.EaseType.easeInOutBack };
                    this.<crownMoveArgs>__5 = iTween.Hash(objArray5);
                    iTween.MoveTo(this.<>f__this.m_crown, this.<crownMoveArgs>__5);
                    object[] objArray6 = new object[] { "rotation", new Vector3(0f, 20f, 0f), "time", this.<resetTime>__0, "isLocal", true, "easetype", iTween.EaseType.linear };
                    this.<godrayRotationArgs>__6 = iTween.Hash(objArray6);
                    iTween.RotateTo(this.<>f__this.m_godRays, this.<godrayRotationArgs>__6);
                    object[] objArray7 = new object[] { "rotation", new Vector3(0f, -20f, 0f), "time", this.<resetTime>__0, "isLocal", true, "easetype", iTween.EaseType.linear };
                    this.<godray2RotationArgs>__7 = iTween.Hash(objArray7);
                    iTween.RotateTo(this.<>f__this.m_godRays2, this.<godray2RotationArgs>__7);
                    this.$PC = -1;
                    break;
                }
            }
