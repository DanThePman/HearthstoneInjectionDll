...
public class SpellMoveToTarget : Spell
{
    ...
    {
        <FindPath>c__AnonStorey38B storeyb = new <FindPath>c__AnonStorey38B();
        tweenPath = null;
        spellPath = null;
        ...
        storeyb.desiredSpellPathName = path.m_PathName.ToLower().Trim();
        iTweenPath path2 = Array.Find<iTweenPath>(pathComponents, new Predicate<iTweenPath>(storeyb.<>m__285));
        if (path2 == null)
        {
            return false;
        }
    ...
    {
        return new <WaitThenDoAction>c__Iterator26A { <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <FindPath>c__AnonStorey38B
    {
        internal string desiredSpellPathName;

        internal bool <>m__285(iTweenPath currTweenPath)
        {
    ...
    [CompilerGenerated]
    private sealed class <WaitThenDoAction>c__Iterator26A : IDisposable, IEnumerator, IEnumerator<object>
    {
