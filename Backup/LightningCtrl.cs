...
public class LightningCtrl : MonoBehaviour
{
    ...
    {
        return new <DestroyLightning>c__Iterator1F3 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <DestroyLightning>c__Iterator1F3 : IDisposable, IEnumerator, IEnumerator<object>
    {
