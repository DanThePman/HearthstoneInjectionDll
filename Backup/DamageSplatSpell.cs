...
public class DamageSplatSpell : Spell
{
    ...
    {
        return new <SplatAnimCoroutine>c__Iterator1CD { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <SplatAnimCoroutine>c__Iterator1CD : IDisposable, IEnumerator, IEnumerator<object>
    {
