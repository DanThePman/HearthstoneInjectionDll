...
public class RenderToTexture : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        this.m_OffscreenPos = new Vector3(offset, offset, offset);
    }
    ...
    private void CreateAlphaCamera()
    {
        if (this.m_AlphaCamera == null)
        {
            ...
            SceneUtils.SetHideFlags(this.m_AlphaCameraGO, HideFlags.HideAndDontSave);
    ...
    private void CreateBloomCaptureCamera()
    {
        if (this.m_BloomCaptureCamera == null)
        {
            ...
            SceneUtils.SetHideFlags(this.m_BloomCaptureCameraGO, HideFlags.HideAndDontSave);
    ...
    private void CreateBloomCapturePlane()
    {
        ...
        {
            this.m_BloomCapturePlaneGameObject.GetComponent<Renderer>().sharedMaterial = this.m_PlaneGameObject.GetComponent<Renderer>().sharedMaterial;
        }
        ...
        SceneUtils.SetHideFlags(this.m_BloomCapturePlaneGameObject, HideFlags.HideAndDontSave);
    }
    ...
    private void CreateBloomPlane()
    {
        ...
        this.m_BloomPlaneGameObject.GetComponent<Renderer>().sharedMaterial.color = this.m_BloomColor;
        SceneUtils.SetHideFlags(this.m_BloomPlaneGameObject, HideFlags.HideAndDontSave);
    }
    ...
    private GameObject CreateMeshPlane(string name, Material material)
    {
        ...
        obj2.GetComponent<Renderer>().material.renderQueue = 0xbb8 + this.m_RenderQueue;
        return obj2;
    }
    ...
    private void CreateTexture()
    {
        if (this.m_RenderTexture == null)
        {
            ...
            if (this.m_RenderMeshAsAlpha)
            {
                ...
                SceneUtils.SetHideFlags(this.m_AlphaRenderTexture, HideFlags.HideAndDontSave);
    ...
    private void Init()
    {
        if (!this.m_init)
        {
            ...
            if (this.m_RenderToObject != null)
            {
                this.m_RenderToObject.GetComponent<Renderer>().material.renderQueue = 0xbb8 + this.m_RenderQueue;
            }
            this.SetupMaterial();
            this.m_init = true;
        }
    ...
    private void LateUpdate()
    {
        if (this.m_renderEnabled)
        {
            ...
            else if ((this.m_RenderMaterial == RenderToTextureMaterial.AlphaClipBloom) || (this.m_RenderMaterial == RenderToTextureMaterial.Bloom))
            {
                this.RenderBloom();
            }
    ...
    {
        if ((this.m_RenderTexture != null) && state)
        {
            this.m_isDirty = true;
            this.RenderTex();
        }
    ...
    private void RenderBloom()
    {
        ...
        else
        {
            ...
            if (this.m_BloomRenderTexture != null)
            {
                SceneUtils.SetHideFlags(this.m_BloomRenderTexture, HideFlags.HideAndDontSave);
            }
            SceneUtils.SetHideFlags(this.m_BloomRenderBuffer1, HideFlags.HideAndDontSave);
            SceneUtils.SetHideFlags(this.m_BloomRenderBuffer2, HideFlags.HideAndDontSave);
            Material bloomMaterial = this.BloomMaterial;
            if (this.m_RenderMaterial == RenderToTextureMaterial.AlphaClipBloom)
            {
                bloomMaterial = this.AlphaClipBloomMaterial;
                ...
                bloomMaterial.SetFloat("_Cutoff", this.m_AlphaClip);
                bloomMaterial.SetFloat("_Intensity", this.m_AlphaClipIntensity);
                bloomMaterial.SetFloat("_AlphaIntensity", this.m_AlphaClipAlphaIntensity);
    ...
    private void RenderTex()
    {
        if (this.m_renderEnabled)
        {
            ...
            if (this.m_init)
            {
                ...
                if (this.m_RenderToObject != null)
                {
                    Renderer component = this.m_RenderToObject.GetComponent<Renderer>();
                    if (component == null)
                    {
                        component = this.m_RenderToObject.GetComponentInChildren<Renderer>();
                    }
                    if (this.m_ShaderTextureName != string.Empty)
                    {
                        component.material.SetTexture(this.m_ShaderTextureName, this.m_RenderTexture);
                    }
                    else
                    {
                        component.material.mainTexture = this.m_RenderTexture;
                    }
                }
                else if (this.m_PlaneGameObject != null)
                {
                ...
                if ((this.m_RenderMaterial == RenderToTextureMaterial.AlphaClip) || (this.m_RenderMaterial == RenderToTextureMaterial.AlphaClipBloom))
                {
                    ...
                    Material sharedMaterial = planeGameObject.GetComponent<Renderer>().sharedMaterial;
    ...
    private void SetupMaterial()
    {
        ...
        switch (this.m_RenderMaterial)
        {
            case RenderToTextureMaterial.Transparent:
                planeGameObject.GetComponent<Renderer>().sharedMaterial = this.TransparentMaterial;
                goto Label_01F3;

            case RenderToTextureMaterial.Additive:
                planeGameObject.GetComponent<Renderer>().sharedMaterial = this.AdditiveMaterial;
                goto Label_01F3;
            ...
            case RenderToTextureMaterial.AlphaClipBloom:
                ...
                planeGameObject.GetComponent<Renderer>().sharedMaterial = alphaClipGradientMaterial;
            ...
            default:
                if (this.m_Material != null)
                {
                    planeGameObject.GetComponent<Renderer>().material = this.m_Material;
                }
                goto Label_01F3;
        }
        planeGameObject.GetComponent<Renderer>().sharedMaterial = alphaClipMaterial;
    ...
    Label_01F3:
        if (planeGameObject.GetComponent<Renderer>().material != null)
        {
            Material material = planeGameObject.GetComponent<Renderer>().material;
        ...
        planeGameObject.GetComponent<Renderer>().material.renderQueue = 0xbb8 + this.m_RenderQueue;
        if (this.m_BloomPlaneGameObject != null)
        {
            this.m_BloomPlaneGameObject.GetComponent<Renderer>().material.renderQueue = (0xbb8 + this.m_RenderQueue) + 1;
        }
