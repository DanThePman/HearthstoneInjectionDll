...
public class ConstructCard : MonoBehaviour
{
    ...
    {
        return new <AnimateObject>c__Iterator27D { animData = animData, <$>animData = animData, <>f__this = this };
    }
    ...
    {
        return new <AttackOnComplete>c__Iterator277 { <>f__this = this };
    }
    ...
    {
        return new <DescriptionOnComplete>c__Iterator276 { <>f__this = this };
    }
    ...
    {
        return new <DoConstruct>c__Iterator274 { <>f__this = this };
    }

    [DebuggerHidden]
    private IEnumerator EndAnimation()
    {
        return new <EndAnimation>c__Iterator27C { <>f__this = this };
    }

    [DebuggerHidden]
    private IEnumerator HealthOnComplete()
    {
        return new <HealthOnComplete>c__Iterator278 { <>f__this = this };
    }
    ...
    {
        return new <ManaGemOnComplete>c__Iterator275 { <>f__this = this };
    }

    [DebuggerHidden]
    private IEnumerator NameOnComplete()
    {
        return new <NameOnComplete>c__Iterator27A { <>f__this = this };
    }
    ...
    {
        return new <PortraitOnComplete>c__Iterator279 { <>f__this = this };
    }

    [DebuggerHidden]
    private IEnumerator RarityOnComplete()
    {
        return new <RarityOnComplete>c__Iterator27B { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <AnimateObject>c__Iterator27D : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard.AnimationData <$>animData;
        internal ParticleSystem[] <$s_1776>__7;
        internal int <$s_1777>__8;
        internal Renderer[] <$s_1778>__11;
        internal int <$s_1779>__12;
        internal ParticleSystem[] <$s_1780>__19;
        internal int <$s_1781>__20;
        ...
        internal Renderer <mesh>__13;
        internal Renderer[] <meshRenders>__10;
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 1:
                    ...
                    if (this.animData.GlowObject != null)
                    {
                        ...
                        this.<$s_1776>__7 = this.<particles>__6;
                        this.<$s_1777>__8 = 0;
                        while (this.<$s_1777>__8 < this.<$s_1776>__7.Length)
                        {
                            this.<ps>__9 = this.<$s_1776>__7[this.<$s_1777>__8];
                            this.<ps>__9.Play();
                            this.<$s_1777>__8++;
                        }
                        if ((this.animData.GlowObjectStandard != null) && (this.animData.GlowObjectUnique != null))
                        {
                            ...
                            {
                                this.animData.GlowObjectUnique.GetComponent<Renderer>().enabled = true;
                            }
                            else
                            {
                                this.animData.GlowObjectStandard.GetComponent<Renderer>().enabled = true;
                            }
                        }
                        else
                        {
                            this.<meshRenders>__10 = this.<glowObj>__5.GetComponentsInChildren<Renderer>();
                            this.<$s_1778>__11 = this.<meshRenders>__10;
                            this.<$s_1779>__12 = 0;
                            while (this.<$s_1779>__12 < this.<$s_1778>__11.Length)
                            {
                                this.<mesh>__13 = this.<$s_1778>__11[this.<$s_1779>__12];
            ...
            if (this.animData.HitBlastParticle != null)
            {
                ...
                this.animData.HitBlastParticle.GetComponent<Renderer>().enabled = true;
            ...
            if (this.animData.GlowObject != null)
            {
                ...
                this.<$s_1780>__19 = this.<particles>__18;
                this.<$s_1781>__20 = 0;
                while (this.<$s_1781>__20 < this.<$s_1780>__19.Length)
                {
                    this.<ps>__21 = this.<$s_1780>__19[this.<$s_1781>__20];
                    this.<ps>__21.Stop();
                    this.<$s_1781>__20++;
                }
            }
            if (this.<>f__this.m_Actor.gameObject != null)
            {
                ...
                CameraShakeMgr.Shake(Camera.main, this.<>f__this.IMPACT_CAMERA_SHAKE_AMOUNT, this.<>f__this.IMPACT_CAMERA_SHAKE_TIME);
    ...
    [CompilerGenerated]
    private sealed class <AttackOnComplete>c__Iterator277 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard <>f__this;
    ...
    [CompilerGenerated]
    private sealed class <DescriptionOnComplete>c__Iterator276 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard <>f__this;
    ...
    [CompilerGenerated]
    private sealed class <DoConstruct>c__Iterator274 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard <>f__this;
        ...
        public bool MoveNext()
        {
            ...
            if (this.<>f__this.m_GhostGlow != null)
            {
                ...
                {
                    this.<>f__this.m_GhostGlow.GetComponent<Renderer>().material.mainTexture = this.<>f__this.m_GhostTextureUnique;
                }
                this.<>f__this.m_GhostGlow.GetComponent<Renderer>().enabled = true;
                this.<>f__this.m_GhostGlow.GetComponent<Animation>().Play("GhostModeHot", PlayMode.StopAll);
            }
            if (this.<>f__this.m_RarityGemMesh != null)
            {
                this.<>f__this.m_RarityGemMesh.GetComponent<Renderer>().enabled = false;
            }
            if (this.<>f__this.m_RarityFrameMesh != null)
            {
                this.<>f__this.m_RarityFrameMesh.GetComponent<Renderer>().enabled = false;
            }
    ...
    [CompilerGenerated]
    private sealed class <EndAnimation>c__Iterator27C : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal Renderer[] <$s_1774>__3;
        internal int <$s_1775>__4;
        internal ConstructCard <>f__this;
        internal ParticleSystem <burst>__0;
        internal Renderer[] <burstParticleRenderers>__2;
        internal Renderer <burstRenderer>__5;
        ...
        Label_00AA:
            ...
            {
                this.<burstParticleRenderers>__2 = this.<burst>__0.GetComponentsInChildren<Renderer>();
                this.<$s_1774>__3 = this.<burstParticleRenderers>__2;
                this.<$s_1775>__4 = 0;
                while (this.<$s_1775>__4 < this.<$s_1774>__3.Length)
                {
                    this.<burstRenderer>__5 = this.<$s_1774>__3[this.<$s_1775>__4];
            ...
            {
                this.<>f__this.m_FuseGlow.GetComponent<Renderer>().enabled = true;
                this.<>f__this.m_FuseGlow.GetComponent<Animation>().Play(this.<fuseAnimation>__6, PlayMode.StopAll);
            }
    ...
    [CompilerGenerated]
    private sealed class <HealthOnComplete>c__Iterator278 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard <>f__this;
    ...
    [CompilerGenerated]
    private sealed class <ManaGemOnComplete>c__Iterator275 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard <>f__this;
    ...
    [CompilerGenerated]
    private sealed class <NameOnComplete>c__Iterator27A : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard <>f__this;
    ...
    [CompilerGenerated]
    private sealed class <PortraitOnComplete>c__Iterator279 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard <>f__this;
    ...
    [CompilerGenerated]
    private sealed class <RarityOnComplete>c__Iterator27B : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal ConstructCard <>f__this;
        ...
        public bool MoveNext()
        {
            ...
            if (this.$PC == 0)
            {
                ...
                if (this.<>f__this.m_Actor.GetCardSet() != TAG_CARD_SET.CORE)
                {
                    if (this.<>f__this.m_RarityGemMesh != null)
                    {
                        this.<>f__this.m_RarityGemMesh.GetComponent<Renderer>().enabled = true;
                    }
                    if (this.<>f__this.m_RarityFrameMesh != null)
                    {
                        this.<>f__this.m_RarityFrameMesh.GetComponent<Renderer>().enabled = true;
                    }
                }
                this.<>f__this.StartCoroutine(this.<>f__this.EndAnimation());
            }
