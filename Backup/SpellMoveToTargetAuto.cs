...
public class SpellMoveToTargetAuto : Spell
{
    ...
    {
        return new <WaitThenDoAction>c__Iterator26B { <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <WaitThenDoAction>c__Iterator26B : IDisposable, IEnumerator, IEnumerator<object>
    {
