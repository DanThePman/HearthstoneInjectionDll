...
public class TutorialKeywordTooltip : MonoBehaviour
{
    ...
    {
        return new <WaitAFrameBeforeSendingEvent>c__Iterator188 { <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <WaitAFrameBeforeSendingEvent>c__Iterator188 : IDisposable, IEnumerator, IEnumerator<object>
    {
