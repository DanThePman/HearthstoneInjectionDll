...
public class Misdirection : Spell
{
    ...
    {
        return new <AnimateReticle>c__Iterator21A { <>f__this = this };
    }
    ...
    {
        return new <ReticleAttackAnimation>c__Iterator21B { <>f__this = this };
    }

    [DebuggerHidden]
    private IEnumerator ReticleFadeIn()
    {
        return new <ReticleFadeIn>c__Iterator219 { <>f__this = this };
    }

    [DebuggerHidden]
    private IEnumerator ReticleFadeOut()
    {
        return new <ReticleFadeOut>c__Iterator21C { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <AnimateReticle>c__Iterator21A : IDisposable, IEnumerator, IEnumerator<object>
    {
    ...
    [CompilerGenerated]
    private sealed class <ReticleAttackAnimation>c__Iterator21B : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal Misdirection <>f__this;
        ...
        internal void <>m__1CD(object col)
        {
        ...
        internal void <>m__1CE(object amount)
        {
            if (this.<>f__this.m_ReticleInstance != null)
            {
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                case 0:
                {
                    this.<reticleAttackColorUpdate>__0 = new Action<object>(this.<>m__1CD);
                    ...
                    this.<reticleFocusUpdate>__4 = new Action<object>(this.<>m__1CE);
    ...
    [CompilerGenerated]
    private sealed class <ReticleFadeIn>c__Iterator219 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal Misdirection <>f__this;
        ...
        internal void <>m__1CC(object amount)
        {
        ...
        public bool MoveNext()
        {
            ...
            if (this.$PC == 0)
            {
                this.<reticleFadeInUpdate>__0 = new Action<object>(this.<>m__1CC);
    ...
    [CompilerGenerated]
    private sealed class <ReticleFadeOut>c__Iterator21C : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal Misdirection <>f__this;
        ...
        internal void <>m__1CF(object amount)
        {
            if (this.<>f__this.m_ReticleInstance != null)
            {
                this.<>f__this.m_ReticleInstance.GetComponent<RenderToTexture>().GetRenderMaterial().SetFloat("_Alpha", (float) amount);
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                case 0:
                {
                    ...
                    this.<reticleFadeOutUpdate>__0 = new Action<object>(this.<>m__1CF);
