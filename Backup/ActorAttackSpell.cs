...
public class ActorAttackSpell : Spell
{
    ...
    {
        return new <WaitThenDoAction>c__Iterator1C7 { prevStateType = prevStateType, <$>prevStateType = prevStateType, <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <WaitThenDoAction>c__Iterator1C7 : IDisposable, IEnumerator, IEnumerator<object>
    {
