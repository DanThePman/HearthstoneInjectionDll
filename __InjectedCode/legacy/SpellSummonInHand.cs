...
class Card : MonoBehaviour
{
    ...
    {
        HearthstoneInjectionDll.Debug.AppendDesktopLog("backToHand", spell.name + "//" + spell.GetTarget().name);
    ...
    void PurgeInactiveSpells()
    {
    }

    bool ShouldPreloadCardAssets()
    {
        return default(bool);
    }

    void OverrideTriggerSpell(int index, Spell spell)
    {
    }
    ...
    Spell GetPlaySpell(bool loadIfNeeded)
    {
        return default(Spell);
    }

    System.Collections.Generic.List<CardSoundSpell> GetPlaySoundSpells(bool loadIfNeeded)
    {
        return default(System.Collections.Generic.List<CardSoundSpell>);
    }

    Spell GetAttackSpell(bool loadIfNeeded)
    {
        return default(Spell);
    }

    System.Collections.Generic.List<CardSoundSpell> GetAttackSoundSpells(bool loadIfNeeded)
    {
        return default(System.Collections.Generic.List<CardSoundSpell>);
    }

    System.Collections.Generic.List<CardSoundSpell> GetDeathSoundSpells(bool loadIfNeeded)
    {
        return default(System.Collections.Generic.List<CardSoundSpell>);
    }

    Spell GetLifetimeSpell(bool loadIfNeeded)
    {
        return default(Spell);
    }

    System.Collections.Generic.List<CardSoundSpell> GetLifetimeSoundSpells(bool loadIfNeeded)
    {
        return default(System.Collections.Generic.List<CardSoundSpell>);
    }
    ...
    Spell GetSubOptionSpell(int index, bool loadIfNeeded)
    {
        return default(Spell);
    }

    System.Collections.Generic.List<CardSoundSpell> GetSubOptionSoundSpells(int index, bool loadIfNeeded)
    {
        return default(System.Collections.Generic.List<CardSoundSpell>);
    }
    ...
    Spell GetTriggerSpell(int index, bool loadIfNeeded)
    {
        return default(Spell);
    }

    System.Collections.Generic.List<CardSoundSpell> GetTriggerSoundSpells(int index, bool loadIfNeeded)
    {
        return default(System.Collections.Generic.List<CardSoundSpell>);
    }
    ...
    void InitEffect(string spellPath, ref CardEffect effect)
    {
    }

    void InitSound(string path, ref CardAudio audio)
    {
    }
    ...
    void SetupSoundSpell(Spell spell)
    {
    }
    ...
    void DestroyCardAudio(ref CardAudio cardAudio)
    {
    }
    ...
    void OnMetaData(Network.HistMetaData metaData)
    {
    }
    ...
    Spell ActivateHandSpawnSpell()
    {
        return default(Spell);
    }

    void ActivateCustomHandSpawnSpell(Spell spell, Card creatorCard)
    {
    }
    ...
    void OnSpellFinished_CustomHandSpawn(Spell spell, object userData)
    {
    }
    ...
    void AnimateDeckToPlay()
    {
    }

    void SetupDeckToPlayActor(Actor actor, UnityEngine.GameObject actorObject)
    {
    }

    System.Collections.IEnumerator AnimateDeckToPlay(Actor cardFaceActor, Spell outSpell, Actor hiddenActor)
    {
        return default(System.Collections.IEnumerator);
    }
    ...
    CardEffect m_customKeywordSpell;
    CardAudio m_announcerLine;
    ...
    System.Collections.Generic.List<CardEffect> m_effects;
    #endregion
