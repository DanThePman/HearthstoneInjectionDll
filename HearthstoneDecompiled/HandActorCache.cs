...
{
    private readonly TAG_CARDTYPE[] ACTOR_CARD_TYPES = new TAG_CARDTYPE[] { TAG_CARDTYPE.MINION, TAG_CARDTYPE.SPELL, TAG_CARDTYPE.WEAPON, TAG_CARDTYPE.HERO };
    ...
    private ActorKey MakeActorKey(TAG_CARDTYPE cardType, TAG_PREMIUM premiumType)
    {
