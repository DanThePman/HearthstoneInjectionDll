...
public class CardBurstEpic : Spell
{
    ...
    {
        return new <DeathState>c__Iterator206 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <DeathState>c__Iterator206 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal CardBurstEpic <>f__this;
