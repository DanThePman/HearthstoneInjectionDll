...
public class GameplayErrorCloud : MonoBehaviour
{
    ...
    {
        return new <StartHideMessageDelay>c__Iterator93 { <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <StartHideMessageDelay>c__Iterator93 : IDisposable, IEnumerator, IEnumerator<object>
    {
