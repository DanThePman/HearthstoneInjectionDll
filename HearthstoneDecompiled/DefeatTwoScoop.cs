...
public class DefeatTwoScoop : EndGameTwoScoop
{
    ...
    {
        return new <AnimateAll>c__Iterator73 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <AnimateAll>c__Iterator73 : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 1:
                {
                    ...
                    object[] objArray6 = new object[] { "rotation", new Vector3(0f, 183f, 0f), "time", 0.5f, "delay", 0.75f, "isLocal", true, "easetype", iTween.EaseType.easeOutBounce };
