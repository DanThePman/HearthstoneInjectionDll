...
public class NAX04_Noth : NAX_MissionEntity
{
    ...
    {
        return new <HandleGameOverWithTiming>c__Iterator15D { gameResult = gameResult, <$>gameResult = gameResult };
    }

    [DebuggerHidden]
    protected override IEnumerator HandleMissionEventWithTiming(int missionEvent)
    {
        return new <HandleMissionEventWithTiming>c__Iterator15E { missionEvent = missionEvent, <$>missionEvent = missionEvent, <>f__this = this };
    }
    ...
    {
        return new <RespondToPlayedCardWithTiming>c__Iterator15F { entity = entity, <$>entity = entity, <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <HandleGameOverWithTiming>c__Iterator15D : IDisposable, IEnumerator, IEnumerator<object>
    {
    ...
    [CompilerGenerated]
    private sealed class <HandleMissionEventWithTiming>c__Iterator15E : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal int <$>missionEvent;
        internal NAX04_Noth <>f__this;
                ...
                case 1:
                    ...
                    if (this.missionEvent == 1)
                    {
                        if (!this.<>f__this.m_heroPowerLinePlayed)
                        {
                            ...
                            Gameplay.Get().StartCoroutine(this.<>f__this.PlaySoundAndBlockSpeech("VO_NAX4_01_HP_02", "VO_NAX4_01_HP_02", Notification.SpeechBubbleDirection.TopRight, this.<enemyActor>__0, 1f, true, false));
                            break;
                            this.$PC = -1;
                        }
                        break;
    ...
    [CompilerGenerated]
    private sealed class <RespondToPlayedCardWithTiming>c__Iterator15F : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        ...
        public bool MoveNext()
        {
            ...
            {
                int num2;
                if (NAX04_Noth.<>f__switch$map1D == null)
                {
                    Dictionary<string, int> dictionary = new Dictionary<string, int>(1);
                    dictionary.Add("NAX4_05", 0);
                    NAX04_Noth.<>f__switch$map1D = dictionary;
                }
                if (NAX04_Noth.<>f__switch$map1D.TryGetValue(cardId, out num2) && (num2 == 0))
                {
                    ...
                    Gameplay.Get().StartCoroutine(this.<>f__this.PlaySoundAndBlockSpeech("VO_NAX4_01_CARD_03", "VO_NAX4_01_CARD_03", Notification.SpeechBubbleDirection.TopRight, this.<enemyActor>__0, 1f, true, false));
                }
            }
            this.$PC = -1;
        Label_0141:
