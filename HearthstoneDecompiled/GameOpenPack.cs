...
public class GameOpenPack : MonoBehaviour
{
    ...
    {
        return new <PlayHoggerAfterVersus>c__Iterator189();
    }
    ...
    [CompilerGenerated]
    private sealed class <PlayHoggerAfterVersus>c__Iterator189 : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 1:
                    this.<hoggerCard>__0 = GameState.Get().GetOpposingSidePlayer().GetHeroCard();
