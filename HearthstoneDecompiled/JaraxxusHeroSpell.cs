...
public class JaraxxusHeroSpell : Spell
{
    ...
    {
        return new <SetupCards>c__Iterator1CE { <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <SetupCards>c__Iterator1CE : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            if (this.<heroPower>__0.IsLoadingAssets() || this.<weapon>__1.IsLoadingAssets())
            {
                this.$current = null;
                this.$PC = 1;
                goto Label_0173;
