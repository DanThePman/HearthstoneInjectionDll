...
public class EndTurnButtonReminder : MonoBehaviour
{
    ...
    {
        return new <WaitAndPlayReminder>c__Iterator8D { delay = delay, card = card, reminderSpell = reminderSpell, <$>delay = delay, <$>card = card, <$>reminderSpell = reminderSpell, <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <WaitAndPlayReminder>c__Iterator8D : IDisposable, IEnumerator, IEnumerator<object>
    {
