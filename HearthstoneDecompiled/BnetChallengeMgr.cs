...
public class BnetChallengeMgr
{
    ...
    private void OnChallengeUpdate(BattleNet.DllChallengeInfo[] challenges)
    {
        ...
        {
            this.FireChallengeEvent(new ChallengeInfo(info.challengeId, info.isRetry, (ChallengeType) info.type));
        }
    }
    ...
    public class ChallengeInfo
    {
        ...
        public ChallengeInfo(ulong id, bool isRetry, ChallengeType type)
        {
            this.m_id = id;
